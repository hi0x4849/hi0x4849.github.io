/*
 * bscript.js - Javascript SVG parser and renderer on Bilibil Script
 * written by 0x4849,10/03/2014
 *
...
bscript_recorder={
	closePath:function(){
		bscript_result+="closePath();\n";
	},
	bezierCurveTo:function(a,b,c,d,e,f){
		//bscript_result+="bezierCurveTo("+a+", "+b+", "+c+", "+d+", "+e+", "+f+");\n";
		bscript_result+="g.graphics.curveTo("+a+", "+b+", "+c+", "+d+");\n";
		bscript_result+="g.graphics.curveTo("+c+", "+d+", "+e+", "+f+");\n";
	},
	quadraticCurveTo:function(a,b,c,d){
		bscript_result+="g.graphics.curveTo("+a+", "+b+", "+c+", "+d+");\n";
	},
	lineTo:function(a,b){
		bscript_result+="g.graphics.lineTo("+a+", "+b+");\n";
	},
	moveTo:function(a,b){
		bscript_result+="g.graphics.moveTo("+a+", "+b+");\n";
	},
	save:function(){
		//bscript_result+="save();";
	},
	fill:function(){
		...
		bscript_result+="g.graphics.endFill();";

		//bscript_result+="fill();";
	},
	stroke:function(){
		//bscript_result+="stroke();";
	},
	restore:function(){
		//bscript_result+="restore();";
	},
	beginPath:function(){
		//bscript_result+="beginPath();";

		bscript_result+="var g = $.createShape({lifeTime:2,x:0,y:0});g.graphics.beginFill(0xFFCC00);";
	},
	canvas:{
		onclick:function(){},
	...
	clearRect:function(a,b,c,d){
		//bscript_result+="clearRect("+a+", "+b+", "+c+", "+d+");";
	}
}
bscript_handler = 
{    
   getContext:function(words)
   {
      return bscript_recorder
   }
...
(function(){
	...
	this.bscript = function (target, s, opts) {
		// no parameters
